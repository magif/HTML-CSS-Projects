...
function palindrome(string) {
  ...
  //keeps only the alphanumeric characters in a string
...
palindrome3 = (string) => {
  ...
  for (let i = 0; i < length / 2; i += 1) {
    ...
    if (lowerRegularString[i] !== lowerRegularString[length - 1 - i]) {
      ...
      //when they don't match simply exit the loop with a false return
      return false;
    }
  }
  return true;
...
console.log(palindrome3("")); //true = nothing reversed is technically true
console.log(palindrome("eye")); // true
console.log(palindrome("race car")); //true
console.log(palindrome("a!a")); //true == "aa"
console.log(palindrome("!")); //true technically = ""
